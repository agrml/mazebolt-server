...
# mb-exam-2
V1_BASE_URL = 'https://www.googleapis.com/compute/v1/projects/mbexam-2017-2'
google_key_file = os.path.dirname(__file__) + "/../../secrets/mbexam-2017-2.pk8.pem"
client_email = 'mbexam2@mbexam-2017-2.iam.gserviceaccount.com'
